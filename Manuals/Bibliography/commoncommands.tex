...
\usepackage[backend=biber, style=numeric, sorting=none, backref=true, giveninits=true, maxbibnames=99]{biblatex}

% Smokeview Version String
\newcommand{\smvversion}{6.6.0}

\newcommand{\hitemini}[1]{\hitem{#1}}
\newcommand{\hitemsmv}[1]{\hitem{#1}}
\newcommand{\hitemssf}[1]{\hitem{#1}}
...
{\em Craig Burkhardt, Acting NIST Director and Acting Undersecretary of Commerce for Standards and Technology}
